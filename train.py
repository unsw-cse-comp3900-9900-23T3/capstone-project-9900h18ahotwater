...
from model import new_design1, new_design2, SFSC, DFDC
...
def main(args):
    ...
    device = "cuda" #torch.device("cuda:0" if torch.cuda.is_available() else "cpu") #"cuda" #torch.device(args.device if torch.cuda.is_available() else "cpu")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default="new_design2")
